  ...
  return (
    <Card title="Input Pemeliharaan">
      <Form form={form} layout="vertical" onFinish={handleSubmit} disabled={!!savedId}>
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item name="armada_id" label="Armada" rules={[{ required: true }]}>
              <Select
                showSearch
          ...
          <Col span={8}>
            <Form.Item name="jenis_kendala" label="Jenis Kendala">
              <Input />
            </Form.Item>
          </Col>
          <Col span={8}>
          ...
          <Col span={8}>
            <Form.Item name="jenis_pekerjaan" label="Jenis Pekerjaan">
              <Input />
            </Form.Item>
          </Col>
          <Col span={8}>
          ...
          <Col span={4}>
            <Form.Item name="biaya" label="Biaya" initialValue={0} rules={[{ required: true }]}>
              <InputNumber style={{ width: "100%" }} min={0} prefix="Rp" />
            </Form.Item>
          </Col>
          <Col span={4}>
            <Form.Item name="jumlah" label="Jumlah" initialValue={1} rules={[{ required: true }]}>
